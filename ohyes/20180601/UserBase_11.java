...
public abstract class UserBase_11 {
	private Logger logger = LoggerFactory.getLogger(UserBase_11.class);
	...
	MartinCalculator_11 martinCalculator = null;
	...
	public void start()  {
		try {
			martinCalculator = new MartinCalculator_11(rule);
