...
public class Honmyo2T extends UserBase {
	private Logger logger = LoggerFactory.getLogger(Honmyo2T.class);
	
	int bettingSortTime;
	MartinKumiban martinCalculator = null;
	DistributeAmount distamo = null; 

	public Honmyo2T(String fromYmd, String toYmd, BettingRule rule) throws Exception{
		super();
...
//		}
	...
	public static void main(String[] args) {
		try {
			...
			BoatProperty.init("C:/Dev/workspace/Oxygen/pod_boatrace/test/properties/honmyo_3.properties");
			BettingRule rule = new BettingRule(BoatProperty.DIRECTORY_PROPERTY + "honmyo_3.properties");
