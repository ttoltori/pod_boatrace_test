...
public class Honmyo3F extends UserBase {
	private Logger logger = LoggerFactory.getLogger(Honmyo3F.class);
	
	int bettingSortTime;
	MartinKumiban martinCalculator = null;
	DistributeAmount distamo = null; 

	public Honmyo3F(String fromYmd, String toYmd, BettingRule rule) throws Exception{
		super();
...
//		}
	...
	public static void main(String[] args) {
		try {
			...
			BoatProperty.init("C:/Dev/workspace/Oxygen/pod_boatrace/test/properties/honmyo_4.properties");
			BettingRule rule = new BettingRule(BoatProperty.DIRECTORY_PROPERTY + "honmyo_4.properties");
//			Honmyo3F user = new Honmyo3F("20170309", "20180505", rule);
