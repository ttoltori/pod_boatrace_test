...
public class Honmyo2F extends UserBase {
	private Logger logger = LoggerFactory.getLogger(Honmyo2F.class);
	
	int bettingSortTime;
	MartinKumiban martinCalculator = null;
	DistributeAmount distamo = null; 

	public Honmyo2F(String fromYmd, String toYmd, BettingRule rule) throws Exception{
		super();
...
//		}
	...
	public static void main(String[] args) {
		try {
			...
			Honmyo2F user = new Honmyo2F("20170309", "20180505", rule);
