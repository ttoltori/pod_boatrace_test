...
public class Honmyo1T extends UserBase {
	...
	public Honmyo1T(String fromYmd, String toYmd, BettingRule rule) throws Exception{
		...
		distamo = new DistributeAmount(rule.getInt("distamoStrategy"), rule.getFloat("distamoFactor1"),
				rule.getInt("baseBetAmount"));
	}
	...
	public static void main(String[] args) {
		try {
			...
			Honmyo1T user = new Honmyo1T("20180309", "20180430", rule);
			user.start();
		} catch (Exception e) {
			e.printStackTrace();
		}
