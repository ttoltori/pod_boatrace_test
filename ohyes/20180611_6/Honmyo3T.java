...
public class Honmyo3T extends UserBase {
	private Logger logger = LoggerFactory.getLogger(Honmyo3T.class);
	
	int bettingSortTime;
	MartinKumiban martinCalculator = null;
	DistributeAmount distamo = null; 

	public Honmyo3T(String fromYmd, String toYmd, BettingRule rule) throws Exception{
		super();
...
//		}
	...
	public static void main(String[] args) {
		try {
			...
			BettingRule rule = new BettingRule(BoatProperty.DIRECTORY_PROPERTY + "honmyo_5.properties");
			Honmyo3T user = new Honmyo3T("20170309", "20180505", rule);
