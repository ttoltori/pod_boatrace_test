...
public abstract class UserBase_10 {
	private Logger logger = LoggerFactory.getLogger(UserBase_10.class);
	...
	MartinCalculator_10 martinCalculator = null;
	...
	public void start()  {
		try {
			martinCalculator = new MartinCalculator_10(rule);
